...
import com.praepositi.fossilsorigins.entity.model.TriceratopsModel;
...
public class TriceratopsRenderer extends GeoEntityRenderer<TriceratopsEntity> {
	...
	@Override
	public RenderType getRenderType(TriceratopsEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {

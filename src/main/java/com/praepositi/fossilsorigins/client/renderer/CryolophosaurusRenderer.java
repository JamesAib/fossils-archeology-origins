...
import com.praepositi.fossilsorigins.entity.model.CryolophosaurusModel;
...
public class CryolophosaurusRenderer extends GeoEntityRenderer<CryolophosaurusEntity> {
	...
	@Override
	public RenderType getRenderType(CryolophosaurusEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {

...
import com.praepositi.fossilsorigins.entity.model.DryosaurusModel;
...
public class DryosaurusRenderer extends GeoEntityRenderer<DryosaurusEntity> {
	...
	@Override
	public RenderType getRenderType(DryosaurusEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {

...
import com.praepositi.fossilsorigins.entity.model.BrachiosaurusModel;
...
public class BrachiosaurusRenderer extends GeoEntityRenderer<BrachiosaurusEntity> {
	...
	@Override
	public RenderType getRenderType(BrachiosaurusEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {

...
import com.praepositi.fossilsorigins.entity.model.StegosaurusModel;
...
public class StegosaurusRenderer extends GeoEntityRenderer<StegosaurusEntity> {
	...
	@Override
	public RenderType getRenderType(StegosaurusEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {

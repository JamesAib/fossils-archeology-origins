...
import com.praepositi.fossilsorigins.entity.model.OviraptorModel;
...
public class OviraptorRenderer extends GeoEntityRenderer<OviraptorEntity> {
	...
	@Override
	public RenderType getRenderType(OviraptorEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {

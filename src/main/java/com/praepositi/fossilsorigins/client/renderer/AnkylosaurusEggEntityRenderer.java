...
public class AnkylosaurusEggEntityRenderer extends MobRenderer<AnkylosaurusEggEntityEntity, ModelDino_EggSmall<AnkylosaurusEggEntityEntity>> {
	public AnkylosaurusEggEntityRenderer(EntityRendererProvider.Context context) {
		super(context, new ModelDino_EggSmall(context.bakeLayer(ModelDino_EggSmall.LAYER_LOCATION)), 0.5f);
	}

	@Override
	public ResourceLocation getTextureLocation(AnkylosaurusEggEntityEntity entity) {

...
import com.praepositi.fossilsorigins.entity.model.DimetrodonModel;
...
public class DimetrodonRenderer extends GeoEntityRenderer<DimetrodonEntity> {
	public DimetrodonRenderer(EntityRendererProvider.Context renderManager) {
		super(renderManager, new DimetrodonModel());
		this.shadowRadius = 0f;
	}

	@Override
	public RenderType getRenderType(DimetrodonEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {

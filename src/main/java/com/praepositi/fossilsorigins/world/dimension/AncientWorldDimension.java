...
package com.praepositi.fossilsorigins.world.dimension;
...
public class AncientWorldDimension {
	...
	public static class Fixers {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("fossilsorigins:ancient_world"), customEffect));
		}
	}
}

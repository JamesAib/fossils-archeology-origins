...
public class VelociraptorEntity extends Animal implements IAnimatable {
	...
	public VelociraptorEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FossilsoriginsModEntities.VELOCIRAPTOR.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "velociraptor");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new BreedGoal(this, 1) {
			...
			public boolean canUse() {
				double x = VelociraptorEntity.this.getX();
				double y = VelociraptorEntity.this.getY();
				double z = VelociraptorEntity.this.getZ();
				Entity entity = VelociraptorEntity.this;
				Level world = VelociraptorEntity.this.level;
		...
		this.goalSelector.addGoal(4, new AvoidEntityGoal<>(this, TyrannosaurausEntity.class, (float) 10, 1, 1.2));
		this.goalSelector.addGoal(5, new AvoidEntityGoal<>(this, SpinosaurusEntity.class, (float) 9, 1, 1.2));
		this.goalSelector.addGoal(6, new AvoidEntityGoal<>(this, CarnotaurusEntity.class, (float) 8, 1, 1.2));
		this.goalSelector.addGoal(7, new AvoidEntityGoal<>(this, CryolophosaurusEntity.class, (float) 8, 1, 1.2));
		this.goalSelector.addGoal(8, new AvoidEntityGoal<>(this, DilophosaurusEntity.class, (float) 8, 1, 1.2));
		this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, GalimimusEntity.class, false, true) {
			@Override
			public boolean canUse() {
				double x = VelociraptorEntity.this.getX();
				double y = VelociraptorEntity.this.getY();
		...
		this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, OviraptorEntity.class, false, true) {
			@Override
			public boolean canUse() {
				double x = VelociraptorEntity.this.getX();
				double y = VelociraptorEntity.this.getY();
		...
		this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, DryosaurusEntity.class, false, true) {
			@Override
			public boolean canUse() {
				double x = VelociraptorEntity.this.getX();
				double y = VelociraptorEntity.this.getY();
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		VelociraptorEntity retval = FossilsoriginsModEntities.VELOCIRAPTOR.get().create(serverWorld);
	...
	private <E extends IAnimatable> PlayState movementPredicate(AnimationEvent<E> event) {
		if (this.animationprocedure.equals("empty")) {
			if ((event.isMoving() || !(event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F))
				...
				event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.velociraptor.move", EDefaultLoopTypes.LOOP));
				return PlayState.CONTINUE;
			}
			event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.velociraptor.idle", EDefaultLoopTypes.LOOP));
			return PlayState.CONTINUE;
		}

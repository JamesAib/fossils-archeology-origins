...
public class TriceratopsEntity extends Animal implements IAnimatable {
	...
	public TriceratopsEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FossilsoriginsModEntities.TRICERATOPS.get(), world);
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new AvoidEntityGoal<>(this, TyrannosaurausEntity.class, (float) 6, 2, 2.2));
		this.goalSelector.addGoal(2, new MeleeAttackGoal(this, 1.2, false) {
			...
			public boolean canUse() {
				double x = TriceratopsEntity.this.getX();
				double y = TriceratopsEntity.this.getY();
				double z = TriceratopsEntity.this.getZ();
				Entity entity = TriceratopsEntity.this;
				Level world = TriceratopsEntity.this.level;
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TriceratopsEntity retval = FossilsoriginsModEntities.TRICERATOPS.get().create(serverWorld);
	...
	private <E extends IAnimatable> PlayState movementPredicate(AnimationEvent<E> event) {
		if (this.animationprocedure.equals("empty")) {
			if ((event.isMoving() || !(event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F))
				...
				event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.Triceratops.move", EDefaultLoopTypes.LOOP));
				return PlayState.CONTINUE;
			}
			event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.Triceratops.idle", EDefaultLoopTypes.LOOP));
			return PlayState.CONTINUE;
		}
